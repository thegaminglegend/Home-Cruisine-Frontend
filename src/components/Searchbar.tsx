  ...
  return (
    <Form {...form}>
      <form
        ...
        className={`flex items-center gap-3 flex-row border-2 rounded-full p-3 ${
      ...
      >
        ...
        <Search
          strokeWidth={2.5}
          size={30}
          className="ml-1 text-mainColor hidden md:block"
        />
        {/* Search Field */}
        <FormField
        ...
        {/* Submit Button */}
        <Button type="submit" className="rounded-full bg-mainColor">
          Search
        </Button>
      </form>
    </Form>
